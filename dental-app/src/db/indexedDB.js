...
export async function initializeDatabase() {
  ...
  if (settingsCount === 0) {
    ...
    // 4. Seed Initial Sample Patients with CPRs
    const today = new Date().toISOString().split('T')[0];
    await db.patients.bulkPut([
      {
        id: 'pat-1',
        file_number: 'PAT-2026-0001',
    ...
    // 5. Seed Vitals for Sample Patients
    await db.vitals.bulkPut([
      {
        id: 'vit-1',
        patient_id: 'pat-1',
        ...
        weight_kg: 78.5,
        pain_scale: 4,
        clinical_notes: 'Patient reports mild discomfort in lower right quadrant (#46 molar).',
      ...
      },
      {
        ...
        weight_kg: 56.0,
        pain_scale: 1,
        clinical_notes: 'Routine 6-month cleaning visit. Oral hygiene satisfactory.',
        created_at: new Date().toISOString()
      }
    ]);
